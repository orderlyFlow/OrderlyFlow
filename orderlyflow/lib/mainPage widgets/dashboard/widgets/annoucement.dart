...
class _announcementState extends State<announcement> {
  ...
  List<AnnouncementData> announceDefault = [AnnouncementData(userName: 'Rai', image: 'assets/images/logo.png', msg: 'Welcome to OrderlyFlow your new companion in this journey...')];
